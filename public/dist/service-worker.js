...
function _regeneratorRuntime() {
  ...
  function d(r, e) {
    ...
    if (o === t)
      return (
        (e.delegate = null),
        ("throw" === n && r.i["return"] && ((e.method = "return"), (e.arg = t), d(r, e), "throw" === e.method)) || ("return" !== n && ((e.method = "throw"), (e.arg = new TypeError("The iterator does not provide a '" + n + "' method")))),
        f
      );
    var i = s(o, r.i, e.arg);
    ...
    return a
      ? a.done
        ? ((e[r.r] = a.value), (e.next = r.n), "return" !== e.method && ((e.method = "next"), (e.arg = t)), (e.delegate = null), f)
        : a
  ...
  return (
    ...
    (Context.prototype = {
      ...
      reset: function reset(r) {
        if (((this.prev = this.next = 0), (this.sent = this._sent = t), (this.done = !1), (this.delegate = null), (this.method = "next"), (this.arg = t), this.tryEntries.forEach(m), !r))
    ...
    caches.open(CACHE_NAME).then(
      /*#__PURE__*/ (function () {
        var _ref = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(cache) {
