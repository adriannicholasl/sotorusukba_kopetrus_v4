      ...
      if (!e._audioUnlocked && e.ctx) {
        ...
        var _o = function o(n) {
          ...
          d.buffer = e._scratchBuffer, d.connect(e.ctx.destination), void 0 === d.start ? d.noteOn(0) : d.start(0), "function" == typeof e.ctx.resume && e.ctx.resume(), d.onended = function () {
            d.disconnect(0), e._audioUnlocked = !0, document.removeEventListener("touchstart", _o, !0), document.removeEventListener("touchend", _o, !0), document.removeEventListener("click", _o, !0);
            for (var n = 0; n < e._howls.length; n++) e._howls[n]._emit("unlock");
          };
        };
        return document.addEventListener("touchstart", _o, !0), document.addEventListener("touchend", _o, !0), document.addEventListener("click", _o, !0), e;
      }
    },
    ...
    play: function play(e, o) {
      ...
      if (t._webAudio) {
        ...
        if (m.readyState >= 3 || y) h();else {
          t._playLock = !0;
          var _g = function g() {
            h(), m.removeEventListener(n._canPlayEvent, _g, !1);
          };
          m.addEventListener(n._canPlayEvent, _g, !1), t._clearTimer(i._id);
        }
      }
      return i._id;
    },
